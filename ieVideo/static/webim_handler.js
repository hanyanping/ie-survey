...
//隐藏评论文本框
    function hideDiscussForm() {
        //$(".ieVideo-discuss-form").hide();
    }

//显示评论文本框
    function showDiscussForm() {
        //$(".ieVideo-discuss-form").show();
    }

//隐藏评论工具栏
    function hideDiscussTool() {
        //$(".ieVideo-discuss-tool").hide();
    }

//显示评论工具栏
    function showDiscussTool() {
        //$(".ieVideo-discuss-tool").show();
    }

//隐藏表情框
    function hideDiscussEmotion() {
        //$(".ieVideo-discuss-emotion").hide();
        ////$(".ieVideo-discuss-emotion").fadeOut("slow");
    }

//显示表情框
    function showDiscussEmotion() {
        //$(".ieVideo-discuss-emotion").show();
        //$(".ieVideo-discuss-emotion").fadeIn("slow");
...
//展示点赞动画
    function showLoveMsgAnimation() {
        ...
        // var toolDiv = document.getElementById("ieVideo-discuss-tool");
...
//显示一条群组系统消息
    ...
    function init(opts) {
      console.log('selType'+opts.selType);
